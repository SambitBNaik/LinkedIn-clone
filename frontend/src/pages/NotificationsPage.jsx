   ...
   const renderNotificationContent =(notification)=>{
    switch(notification.type){
        ...
        case "connectionAccepted":
            return(
                <span>
                    <Link to={`profile/${notification.relatedUser.username}`} className='fornt-bold'>
                         {notification.relatedUser.name}
                    </Link>{" "}
   ...
   const renderRelatedPost=(relatedPost)=>{
    ...
    return(
        <Link 
            ...
            className='mt-2 bg-gray-50 rounded-md flex items-center space-x-2 hover:bg-gray-100 transition-colors'
        >
          {relatedPost.image &&(
